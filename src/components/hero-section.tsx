      ...
      <div className="section-container py-24 relative z-10">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          <div className="text-center flex-1">
            ...
            <h1
              className="text-6xl sm:text-7xl lg:text-8xl font-bold tracking-tight mb-6 animate-fade-in-up"
            ...
            <div
              className="h-12 lg:h-16 mb-8 animate-fade-in-up"
              style={{ animationDelay: "0.5s" }}
            >
              <p className="text-3xl sm:text-4xl lg:text-5xl font-light text-foreground/70">
                <span
                  ref={textRef}
                  className="border-r-2 border-primary/60 pr-1"
                />
              </p>
            </div>

            <p
              className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-6 leading-relaxed animate-fade-in-up"
