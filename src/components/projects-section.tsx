...
function ProjectCard({
  ...
  return (
    <div
      className={cn(
        "group relative glass-card rounded-2xl overflow-hidden transition-all duration-700 h-full",
      ...
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Selected projects demonstrating practical solutions and
            well-architected digital experiences.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center max-w-7xl mx-auto">
